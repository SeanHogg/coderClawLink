...
The `Dockerfile` and `docker-compose.yml` in this repo support `dev`, `deploy`, and `migrate` profiles for Docker-based self-hosted deployments. See [getting-started.md](./getting-started.md) for full setup instructions.
