...
See [api-reference.md](./api-reference.md) for full parameter documentation.
...
See [multi-agent-orchestration.md](./multi-agent-orchestration.md) for details on multi-agent workflow patterns.
...
- [Multi-Agent Orchestration](./multi-agent-orchestration.md) — workflow patterns
